...
data class ContactState(
    ...
    val showExportContact: Boolean = false,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        if (showExportContact != other.showExportContact) return false
        if (showCamera != other.showCamera) return false
        if (pictureTaken != other.pictureTaken) return false
        if (currentContact != other.currentContact) return false
